      ...
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mb-12 bg-white rounded-xl border border-gray-200 p-8 hover:shadow-lg transition-shadow">
          ...
          <div className="bg-blue-50 border-l-4 border-blue-500 p-4 rounded mb-4">
            <ul className="space-y-2 text-gray-800">
              <li className="flex items-start"><span className="text-blue-500 mr-2 mt-1">•</span><div><strong>Encryption in Transit:</strong> All data transmitted between your device and our servers uses TLS 1.2 or higher encryption protocols, the same security standard used by banks and financial institutions.</div></li>
              <li className="flex items-start"><span className="text-blue-500 mr-2 mt-1">•</span><div><strong>Encryption at Rest:</strong> Sensitive data stored in our systems is encrypted using AES-256 encryption, a military-grade encryption standard.</div></li>
              <li className="flex items-start"><span className="text-blue-500 mr-2 mt-1">•</span><div><strong>Network Segmentation:</strong> Our infrastructure uses network isolation and access controls to limit exposure between different system components.</div></li>
              <li className="flex items-start"><span className="text-blue-500 mr-2 mt-1">•</span><div><strong>Least Privilege Access:</strong> System access follows the principle of least privilege, ensuring personnel and services only access data necessary for their function.</div></li>
              <li className="flex items-start"><span className="text-blue-500 mr-2 mt-1">•</span><div><strong>Regular Backups:</strong> Automated backup systems ensure business continuity and disaster recovery capabilities.</div></li>
            </ul>
          </div>
        </div>
        ...
        <div className="mb-12 bg-white rounded-xl border border-gray-200 p-8 hover:shadow-lg transition-shadow">
          ...
          <ul className="space-y-2 text-gray-700">
            <li className="flex items-start"><span className="text-blue-500 mr-2 mt-1">•</span><div><strong>Two-Factor Authentication (2FA):</strong> Enable an extra layer of security requiring both your password and a time-based one-time password (TOTP) from an authenticator app. We support standard authenticator apps like Google Authenticator, Authy, and Microsoft Authenticator.</div></li>
            <li className="flex items-start"><span className="text-blue-500 mr-2 mt-1">•</span><div><strong>Strong Password Requirements:</strong> Account passwords must meet minimum complexity requirements including length, character diversity, and protection against common weak passwords.</div></li>
            <li className="flex items-start"><span className="text-blue-500 mr-2 mt-1">•</span><div><strong>Session Management:</strong> Active session monitoring with automatic timeout for inactive sessions and the ability to remotely log out from all devices.</div></li>
            <li className="flex items-start"><span className="text-blue-500 mr-2 mt-1">•</span><div><strong>Login Attempt Monitoring:</strong> Automated detection of suspicious login patterns including brute-force attacks, credential stuffing attempts, and access from unusual locations.</div></li>
            <li className="flex items-start"><span className="text-blue-500 mr-2 mt-1">•</span><div><strong>Email Notifications:</strong> Receive alerts for important account activities including logins from new devices, password changes, and security setting modifications.</div></li>
          </ul>
        </div>
        ...
        <div className="mb-12 bg-white rounded-xl border border-gray-200 p-8 hover:shadow-lg transition-shadow">
          ...
          <ul className="space-y-2 text-gray-700">
            <li className="flex items-start"><span className="text-blue-500 mr-2 mt-1">•</span><div><strong>Real-Time Monitoring:</strong> Automated systems analyze transaction patterns 24/7 to identify unusual or suspicious activity before funds are transferred.</div></li>
            <li className="flex items-start"><span className="text-blue-500 mr-2 mt-1">•</span><div><strong>Risk-Based Analysis:</strong> Each transaction is evaluated against multiple risk signals including transaction amount, frequency, recipient details, geographic factors, and historical behavior patterns.</div></li>
            <li className="flex items-start"><span className="text-blue-500 mr-2 mt-1">•</span><div><strong>Transaction Limits:</strong> Configurable daily and per-transaction limits help prevent unauthorized large transfers while allowing you to control your account's risk exposure.</div></li>
            <li className="flex items-start"><span className="text-blue-500 mr-2 mt-1">•</span><div><strong>Recipient Verification:</strong> Multi-step confirmation process ensures you review all recipient details before finalizing any transfer.</div></li>
            <li className="flex items-start"><span className="text-blue-500 mr-2 mt-1">•</span><div><strong>Device Fingerprinting:</strong> Recognition of trusted devices to detect access from unfamiliar or potentially compromised devices.</div></li>
          </ul>
        ...
        <div className="mb-12 bg-white rounded-xl border border-gray-200 p-8 hover:shadow-lg transition-shadow">
          ...
          <div className="bg-blue-50 border-l-4 border-blue-500 p-4 rounded mb-4">
            <p className="text-gray-800 mb-2"><strong className="text-blue-700">SwiftMonday's Role:</strong></p>
        ...
        <div className="mb-12 bg-white rounded-xl border border-gray-200 p-8 hover:shadow-lg transition-shadow">
          ...
          <ul className="space-y-2 text-gray-700">
            <li className="flex items-start"><span className="text-blue-500 mr-2 mt-1">•</span><div><strong>No Sale of Personal Data:</strong> We do not sell your personal information for money. Your data is used solely to provide remittance services and meet legal requirements.</div></li>
            <li className="flex items-start"><span className="text-blue-500 mr-2 mt-1">•</span><div><strong>Data Minimization:</strong> We collect only information necessary to provide services, verify identity, and comply with legal obligations.</div></li>
            <li className="flex items-start"><span className="text-blue-500 mr-2 mt-1">•</span><div><strong>Retention Policies:</strong> Personal data is retained only as long as necessary for service provision and legal compliance (typically 5-7 years for financial records).</div></li>
            <li className="flex items-start"><span className="text-blue-500 mr-2 mt-1">•</span><div><strong>Access Controls:</strong> Strict internal access controls limit who can view personal information based on job function and business need.</div></li>
            <li className="flex items-start"><span className="text-blue-500 mr-2 mt-1">•</span><div><strong>Your Privacy Rights:</strong> Subject to legal requirements for AML/KYC compliance, you may request access to your data, correction of inaccuracies, or deletion of your account.</div></li>
            <li className="flex items-start"><span className="text-blue-500 mr-2 mt-1">•</span><div><strong>California Privacy Rights:</strong> California residents have additional rights under CCPA/CPRA including the right to know, delete, correct, and opt-out of data sharing.</div></li>
          </ul>
          <div className="mt-4">
        ...
        <div className="mb-12 bg-white rounded-xl border border-gray-200 p-8 hover:shadow-lg transition-shadow">
          ...
          <ul className="space-y-2 text-gray-700">
            <li className="flex items-start"><span className="text-blue-500 mr-2 mt-1">•</span><div><strong>Due Diligence:</strong> All payment partners and service providers undergo security assessments before integration to ensure they meet our security standards.</div></li>
            <li className="flex items-start"><span className="text-blue-500 mr-2 mt-1">•</span><div><strong>Contractual Protections:</strong> Data processing agreements require third parties to implement appropriate security measures and use data only for specified purposes.</div></li>
            <li className="flex items-start"><span className="text-blue-500 mr-2 mt-1">•</span><div><strong>Regulatory Compliance:</strong> Payment partners maintain their own regulatory licenses, compliance certifications, and audit requirements.</div></li>
            <li className="flex items-start"><span className="text-blue-500 mr-2 mt-1">•</span><div><strong>Ongoing Monitoring:</strong> We monitor service provider performance and security posture on an ongoing basis.</div></li>
          </ul>
        </div>
        ...
        <div className="mb-12 bg-white rounded-xl border border-gray-200 p-8 hover:shadow-lg transition-shadow">
          ...
          <ul className="space-y-2 text-gray-700">
            <li className="flex items-start"><span className="text-blue-500 mr-2 mt-1">•</span><div><strong>OWASP Standards:</strong> Our development follows Open Web Application Security Project (OWASP) guidelines for secure application design and coding practices.</div></li>
            <li className="flex items-start"><span className="text-blue-500 mr-2 mt-1">•</span><div><strong>Security Patches:</strong> Regular updates and security patches are applied promptly to address vulnerabilities in dependencies and infrastructure components.</div></li>
            <li className="flex items-start"><span className="text-blue-500 mr-2 mt-1">•</span><div><strong>Vulnerability Management:</strong> Ongoing scanning for security vulnerabilities in code, dependencies, and infrastructure with prioritized remediation.</div></li>
            <li className="flex items-start"><span className="text-blue-500 mr-2 mt-1">•</span><div><strong>Penetration Testing:</strong> Periodic security testing by qualified professionals to identify and address potential weaknesses.</div></li>
            <li className="flex items-start"><span className="text-blue-500 mr-2 mt-1">•</span><div><strong>Code Reviews:</strong> Security-focused code review processes before deploying changes to production systems.</div></li>
          </ul>
        ...
        <div className="mb-12 bg-white rounded-xl border border-gray-200 p-8 hover:shadow-lg transition-shadow">
          ...
          <ul className="space-y-2 text-gray-700">
            <li className="flex items-start"><span className="text-blue-500 mr-2 mt-1">•</span><div><strong>24/7 Monitoring:</strong> Continuous monitoring of systems for security events and anomalies with automated alerting for critical incidents.</div></li>
            <li className="flex items-start"><span className="text-blue-500 mr-2 mt-1">•</span><div><strong>Incident Classification:</strong> Rapid assessment and classification of security events based on severity and potential impact.</div></li>
            <li className="flex items-start"><span className="text-blue-500 mr-2 mt-1">•</span><div><strong>Containment & Recovery:</strong> Immediate containment actions to limit exposure followed by system recovery and security hardening.</div></li>
            <li className="flex items-start"><span className="text-blue-500 mr-2 mt-1">•</span><div><strong>Customer Notification:</strong> In the event of a data breach affecting personal information, we will notify affected users without unreasonable delay as required by applicable law.</div></li>
            <li className="flex items-start"><span className="text-blue-500 mr-2 mt-1">•</span><div><strong>Regulatory Reporting:</strong> Timely notification to appropriate regulatory authorities and law enforcement as required by law.</div></li>
            <li className="flex items-start"><span className="text-blue-500 mr-2 mt-1">•</span><div><strong>Post-Incident Review:</strong> Comprehensive analysis after incidents to identify root causes and implement preventive measures.</div></li>
          </ul>
        </div>
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <div className="bg-blue-50 border border-blue-200 p-4 rounded">
                ...
                <ul className="space-y-1 text-sm text-gray-700">
                  <li className="flex items-start"><span className="text-blue-500 mr-2">•</span><div>Detailed description of the vulnerability</div></li>
                  <li className="flex items-start"><span className="text-blue-500 mr-2">•</span><div>Steps to reproduce the issue</div></li>
                  <li className="flex items-start"><span className="text-blue-500 mr-2">•</span><div>Potential impact assessment</div></li>
                  <li className="flex items-start"><span className="text-blue-500 mr-2">•</span><div>Any proof-of-concept code or screenshots (if applicable)</div></li>
                  <li className="flex items-start"><span className="text-blue-500 mr-2">•</span><div>Your contact information for follow-up</div></li>
                </ul>
        ...
        <div className="mb-12 bg-blue-50 border-2 border-blue-200 rounded-xl p-6 text-center">
